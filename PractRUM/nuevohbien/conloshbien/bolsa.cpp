...
void inicializarBolsa(tBolsa& bolsa) {
	int color = 0;
	bolsa.bolsa = new tMatBolsa[NUMFICHAS];
...
void repartir(tBolsa& bolsa, tSoportes& soportes) {
	//soportes.soportes = new tListaSoportes[NUMJUGADORES];
	for (int i = 0; i < NUMJUGADORES; i++) {
		soportes.soportes[i].ficha = new tFicha[NUMFICHAS];
